...
import { Flex, Button, IconButton, DropdownWrapper, Option } from "@/components/once-ui";
  ...
  return (
    ...
    >
      {(codeInstances.length > 1 || (copyButton && !compact)) && (
        <Flex borderBottom="neutral-medium" zIndex={2} fillWidth justifyContent="between">
